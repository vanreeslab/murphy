...
class GhostBlock : public SubBlock {
   protected:
    level_t dlvl_;      //!< delta level = neighbor level - my level (see @ref InterpolatingWavelet)
    lid_t   shift_[3];  //!<  my (0,0,0) in the framework of my neighbour  (see @ref InterpolatingWavelet::interpolate_())
