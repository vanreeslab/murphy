#ifndef SRC_RK3_LS_HPP_
#define SRC_RK3_LS_HPP_
...
/**
 * @brief provides an implementation of a RK3 Low Storage.
...
class RK3_LS {
   ...
   public:
    explicit RK3_LS(const real_t c2, m_ptr<Grid> grid, m_ptr<Field> state, m_ptr<Stencil> f, m_ptr<Prof> prof);
    virtual ~RK3_LS();
