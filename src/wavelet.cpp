...
//  */
// real_t InterpolatingWavelet::Criterion(MemLayout* block, data_ptr data) {
//     //-------------------------------------------------------------------------
...
//  */
// void InterpolatingWavelet::Details(MemLayout* block, data_ptr data, real_t* details_max) {
//     //-------------------------------------------------------------------------
//     interp_ctx_t ctx;
//     // get memory details
...
//  */
// void InterpolatingWavelet::Coarsen_(const interp_ctx_t* ctx) {
//     //-------------------------------------------------------------------------
...
//  * @param ctx the interpolation context
//  */
// void InterpolatingWavelet::Refine_(const interp_ctx_t* ctx) {
//     //-------------------------------------------------------------------------
//     // assure alignment for the target, the source, the constant and the temp data
//     const real_t  alpha    = ctx->alpha;
...
//  */
// void InterpolatingWavelet::Detail_(const interp_ctx_t* ctx, real_t* details_max) {
//     //-------------------------------------------------------------------------
