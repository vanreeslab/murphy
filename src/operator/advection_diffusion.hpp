...
template <sid_t length_advection, sid_t length_diffusion>
void AdvectionDiffusion<length_advection, length_diffusion>::DoMagic(m_ptr<const qid_t> qid, m_ptr<GridBlock> block, const bool is_outer, m_ptr<const Field> fid_src, m_ptr<Field> fid_trg) {
