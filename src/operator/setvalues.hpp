...
extern lambda_t<real_t, const real_t[], const real_t[], const lda_t, const real_t, const real_t, const real_t, const std::vector<short_t>, const std::vector<real_t> > scalar_compact_ring;
