...
constexpr short_t len_ha_ = 0;  //!< length of the Ha filter
template <lda_t N, lda_t NT>
constexpr short_t len_ga_ = 0;  //!< length of the S dual filter
template <lda_t N, lda_t NT>
constexpr short_t len_js_ = 0;  //!< length of the Js filter
template <lda_t N, lda_t NT>
constexpr short_t len_ks_ = 0;  //!< length of the Ks filter

/** @brief Ha filter, used to compute the coarser scaling coefficients */
template <lda_t N, lda_t NT>
constexpr real_t ha_[1] = {0.0};
 ...
 */
template <lda_t N, lda_t NT>
constexpr real_t ks_[1] = {0.0};

/**
 * @brief constant in front of the epsilon 
 */
template <lda_t N, lda_t NT>
constexpr real_t eps_c = 1.0;
