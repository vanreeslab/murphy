...
template <sid_t length_advection, sid_t length_diffusion>
void Conservative_AdvectionDiffusion<length_advection, length_diffusion>::DoMagic(const qid_t* qid, GridBlock* block, const bool is_outer, Field* fid_src, Field* fid_trg) {
