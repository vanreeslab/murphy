...
do
    ...
    do
        ...
        # run that shit
        /home/ucl/tfl/tgillis/lib-mpich/mpich-3.4.1/bin/mpirun -f ${MACHINEFILE} ./${MURPHY_NAME} --conv-weno --ilevel=2 > log_${N}${NT}_$SLURM_JOB_ID.log
        /home/ucl/tfl/tgillis/lib-mpich/mpich-3.4.1/bin/mpirun -f ${MACHINEFILE} ./${MURPHY_NAME} --conv-weno --ilevel=2 --no-adapt > log_${N}${NT}_$SLURM_JOB_ID.log
