...
//         // shift
//         ASSERT_EQ(interp.criterion_shift_front(), 1);
//         ASSERT_EQ(interp.criterion_shift_back(), 0);
...
//         // shift
//         ASSERT_EQ(interp.criterion_shift_front(), 0);
//         ASSERT_EQ(interp.criterion_shift_back(), 0);
...
//         // shift
//         ASSERT_EQ(interp.criterion_shift_front(), 3);
//         ASSERT_EQ(interp.criterion_shift_back(), 2);
