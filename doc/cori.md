...
#or 
CC=mpicc CXX=mpicxx F77=mpifort FC=mpifort ./configure --prefix=/global/homes/t/tgillis/p4est-2.3.2-gcc10.1.0-openmpi4.1.2rc2 CFLAGS="-Ofast -Wall -fopenmp" --enable-mpi --enable-openmp
